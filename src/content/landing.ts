...
There is a cleaner arrangement. Twenty-four programs form a Champions Conference, chosen on merit and refreshed annually through promotion and relegation, playing a schedule that ends in the College Football Playoff. Everyone else plays in their existing conferences, at a sensible regional scale, with a real path up: win your conference, enter a promotion playoff, and earn your way in.
...
export const argumentSections: ArgumentSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      `The rivalries survive. Each program's home conference selects its two rivalry-game opponents, and those games count. Ohio State and Michigan. Texas and Texas A&M. USC and Notre Dame. Whichever rivalry the program has, the proposal keeps it. Cross-conference rivalries are permitted and, in some cases, restored. The proposal does not ask the sport to give up what it loves about itself. It asks the sport to stop apologizing for the parts that don't work.`,
    ],
    pullquote:
  ...
  },
  {
    ...
    pullquote: 'Staying becomes a strategy, not a sacrifice.',
  },
];
